...
const styles = StyleSheet.create({
  ...
  referenceCardSelected: {
    ...
    shadowColor: tokens.colors.status.success,
    shadowOpacity: 0.3,
  },
  referenceImage: {
    width: '100%',
        ...
        >
          ...
          >
            <Ionicons
              ...
              size={20}
              color={isFavorite ? tokens.colors.primary.DEFAULT : tokens.colors.background.secondary}
            />
          </TouchableOpacity>
      ...
      >
        ...
        <View style={styles.infoSection}>
          ...
          {selectedReferences.length > 0 && (
            <View style={styles.selectionCounter}>
              <Ionicons name="images" size={16} color={tokens.colors.primary.DEFAULT} />
        ...
        {references.length === 0 && !isLoading && (
          <View style={styles.noReferencesContainer}>
            <Ionicons name="image-outline" size={64} color={tokens.colors.text.tertiary} />
          ...
          <View style={styles.modalContainer}>
            <BlurView intensity={90} tint="dark" style={styles.modalBlur}>
              ...
              <TouchableOpacity
                ...
                onPress={() => setPreviewImage(null)}
              >
                <Ionicons name="close" size={24} color={tokens.colors.background.secondary} />
              </TouchableOpacity>
            </BlurView>
          </View>
        )}
