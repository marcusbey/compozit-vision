    ...
    <View style={styles.emptyState}>
      ...
      <View style={styles.emptyActions}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Ionicons name="image" size={20} color={tokens.colors.primary.DEFAULT} />
            ...
            <View style={styles.colorGrid}>
              ...
              {createPaletteModal.colors.length < 6 && (
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Ionicons name="add" size={24} color={tokens.colors.text.secondary} />
                </TouchableOpacity>
              )}
            </View>
          </View>
          ...
          <ScrollView style={styles.modalContent}>
              ...
              <View style={styles.detailItem}>
                ...
                <View style={styles.propertiesGrid}>
                  <View style={styles.propertyItem}>
                    <Ionicons name="thermometer" size={20} color={tokens.colors.text.secondary} />
                    <Text style={styles.propertyText}>{palette.color_temperature}</Text>
                  </View>
                  <View style={styles.propertyItem}>
                    <Ionicons name="sunny" size={20} color={tokens.colors.text.secondary} />
                    <Text style={styles.propertyText}>{palette.brightness_level}</Text>
                  </View>
                  <View style={styles.propertyItem}>
                    <Ionicons name="contrast" size={20} color={tokens.colors.text.secondary} />
                    <Text style={styles.propertyText}>{palette.saturation_level}</Text>
                  </View>
                  <View style={styles.propertyItem}>
                    <Ionicons name="color-filter" size={20} color={tokens.colors.text.secondary} />
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Ionicons name="brush" size={20} color={tokens.colors.text.inverse} />
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Ionicons name="copy" size={20} color={tokens.colors.primary.DEFAULT} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {!isLoading && filteredPalettes.length > 0 && !selectionMode && (
        ...
        >
          <LinearGradient
            colors={[tokens.colors.primary.DEFAULT, tokens.colors.primary.DEFAULTHover]}
            style={styles.fabGradient}
          >
            <Ionicons name="add" size={24} color={tokens.colors.text.inverse} />
          </LinearGradient>
        </TouchableOpacity>
      )}
